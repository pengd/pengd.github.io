...
CodeFuse: Our foundational pretrained code LLM, designed to enhance coding effectiveness. It is open-sourced  on [GitHub](https://github.com/codefuse-ai) and [HuggingFace](https://huggingface.co/codefuse-ai). 

Ling-Coder-Lite: We are excited to release our latest Mixture-of-Experts (MoE) code LLM, built on the Ant Ling-MoE architecture. To foster community collaboration, we have made the model, its [technical report](https://arxiv.org/abs/2503.17793), [SFT dataset](https://huggingface.co/datasets/inclusionAI/Ling-Coder-SFT), and the corresponding [SFT dataset](https://huggingface.co/datasets/inclusionAI/Ling-Coder-SFT) and [DPO dataset](https://huggingface.co/datasets/inclusionAI/Ling-Coder-DPO) datasets publicly available. Explore Ling-Coder-Lite on [GitHub](https://github.com/codefuse-ai/Ling-Coder-Lite) and [HuggingFace](https://huggingface.co/inclusionAI/Ling-Coder-lite).

CodeFuse-CGM: is a graph-based framework for software engineering tasks that employs a repository-level code graph to capture structural context and a four-step R4 chain (Rewriter, Retriever, Reranker, Reader) to resolve issues. CGM-72B-V1.2 has achieved a remarkable 44.00% resolve rate on the SWE-Bench-Lite leaderboard, marking a significant improvement in its performance and capabilities. CGM has been open-sourced on <a href="https://github.com/codefuse-ai/CodeFuse-CGM">Github</a> and&nbsp;<a href="https://huggingface.co/inclusionAI/Ling-Coder-lite">HuggingFace</a>. The <a href="https://arxiv.org/abs/2505.16901">technical report</a> has been accepted by NeurIPS'25.

OpenDeRisk: Beyond models, we have also open-sourced OpenDeRisk, an AI-native risk intelligence system. It empowers your application to act as a 24/7 risk-aware manager, delivering continuous and comprehensive protection. Check out the [technical report](https://arxiv.org/abs/2510.13561) and the project on [GitHub](https://github.com/derisk-ai/OpenDerisk).
